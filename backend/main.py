...
from backend.routes.intelligence_modules import router as intelligence_modules_router
...
app.include_router(intelligence_modules_router, prefix="/intelligence-data", tags=["Intelligence Modules"])
@app.get("/")
